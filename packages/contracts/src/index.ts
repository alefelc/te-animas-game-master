...
const CandidateInputSchema = z.object({
  ...
  weight: z.number().min(1).max(10000).optional().default(100),
  element_slugs: z.array(z.string()).max(30).optional().default([]),
  toy_slugs: z.array(z.string()).max(30).optional().default([]),
  uses_selected_inventory: z.boolean().optional().default(false),
  contains_penetration: z.boolean().optional().default(false),
  contains_toy: z.boolean().optional().default(false),
  contains_oral: z.boolean().optional().default(false),
  contains_manual_stimulation: z.boolean().optional().default(false),
  ...
  card_kind: CardKindSchema.optional().default("action"),
  scene_phase_min: ScenePhaseSchema.optional().default("connection"),
  scene_phase_max: ScenePhaseSchema.optional().default("closure"),
  scene_phase_after: ScenePhaseSchema.optional().default("connection"),
  physical_state_min: PhysicalStateSchema.optional().default("clothed"),
  physical_state_after: PhysicalStateSchema.optional().default("clothed"),
  activity_family: z.string().max(80).nullable().optional().default(null),
  activity_action: ActivityActionSchema.optional().default("none"),
  requires_previous_activity: z.string().max(80).nullable().optional().default(null),
  forbidden_after_activity: z.string().max(80).nullable().optional().default(null),
  allow_activity_change: z.boolean().optional().default(true),
  allow_position_change: z.boolean().optional().default(true),
  allow_rhythm_change: z.boolean().optional().default(true),
  inventory_action: InventoryActionSchema.optional().default("none"),
  estimated_duration_seconds: z.number().int().min(0).max(7200).optional().default(0),
  variant_group: z.string().max(120).nullable().optional().default(null),
  cooldown_sessions: z.number().int().min(0).max(100).optional().default(2),
...
export const NextRequestSchema = z.object({
  ...
  scene_state: SceneStateSchema.optional().default(initialSceneState()),
