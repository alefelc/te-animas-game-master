...
function requestShapeSummary(value) {
...
function recordValidationFailure(requestId, error, rawBody) {
...
const server = createServer(async (request, response) => {
    ...
    if (request.method === "GET" && requestUrl.pathname === "/diagnostics/contract") {
        ...
        const selectedFailure = requestedFailureId
            ? recentValidationFailures.find((failure) => failure.request_id === requestedFailureId) ?? null
